...
def test_gradplotter(example):
    ...
    with cd(model.source_dir):
        ...
        for i, batch in enumerate(tqdm(it)):
            ...
            # make the prediction
            pred_batch = model.input_grad(batch['inputs'], avg_func="sum", wrt_layer=predict_activation_layers[example],
    ...
    gp = GradPlotter(output, example_dir, source ="dir")
